...
namespace GetAudio
{
    ...
    public IConfiguration Configuration { get; }
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "GetAudio", Version = "v1" });
            });
            services.AddCors(options =>
            {
                options.AddPolicy(name: "AudioPolicy",
                                  policy =>
                                  {
            ...
            services.AddScoped<IGetAudioRepo, GetAudioRepo>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "GetAudio v1"));
            }
